...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_horizontal_nav_acc' => $themify_customizer->accordion_start( __( 'Horizontal Navigation', 'themify' ) ),

		'horizontal_nav' => array(
			'control' => array(
				'type'    => 'nav_menu',
				'label'   => __( 'Horizontal Navigation Menu', 'themify' ),
				'location' => 'horizontal-menu',
			),
		),

		'horizontal_nav_position' => array(
			'control' => array(
				'type'    => 'Themify_Position_Control',
				'label'   => __( 'Menu Container', 'themify' ),
			),
		...
		'horizontal_nav_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Menu Container Background', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Menu Link', 'themify' ),
			),
			'selector' => '#horizontal-menu a',
			'prop' => 'font',
		),

		'horizontal_nav_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Link Color', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Link Background', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Menu Link Border', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Menu Link Padding', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Menu Link Margin', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Link Hover', 'themify' ),
			...
			'selector' => '#horizontal-menu a:hover',
			'prop' => 'background',
		),

		'horizontal_nav_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Link Hover Color', 'themify' ),
		...
		'horizontal_nav_link_active_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Active Link', 'themify' ),
			...
			'selector' => '#horizontal-menu .current_page_item a,  #horizontal-menu .current-menu-item a',
			'prop' => 'background',
		),

		'horizontal_nav_link_active_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Active Link Color', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_link_active_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Active Link Hover', 'themify' ),
			...
			'selector' => '#horizontal-menu .current_page_item a:hover,  #horizontal-menu .current-menu-item a:hover',
			'prop' => 'background',
		),

		'horizontal_nav_link_active_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Active Link Hover Color', 'themify' ),
		...
		'horizontal_nav_dropdown_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Dropdown Container', 'themify' ),
			),
			'selector' => '#horizontal-menu ul',
			'prop' => 'background',
		),

		'horizontal_nav_dropdown_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Dropdown Container Border', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Dropdown Container Padding', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Dropdown Container Margin', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Dropdown Link', 'themify' ),
			),
			'selector' => '#horizontal-menu ul a, #horizontal-menu .current_page_item ul a, #horizontal-menu ul .current_page_item a, #horizontal-menu .current-menu-item ul a, #horizontal-menu ul .current-menu-item a',
			'prop' => 'font',
		),

		'horizontal_nav_dropdown_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Color', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Background', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Dropdown Link Border', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Dropdown Link Padding', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Dropdown Link Margin', 'themify' ),
				'show_label' => false,
		...
		'horizontal_nav_dropdown_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Hover', 'themify' ),
		...
		'horizontal_nav_dropdown_link_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Hover Background', 'themify' ),
			...
			'selector' => '#horizontal-menu ul a:hover,  #horizontal-menu .current_page_item ul a:hover,  #horizontal-menu ul .current_page_item a:hover,  #horizontal-menu .current-menu-item ul a:hover,  #horizontal-menu ul .current-menu-item a:hover',
			'prop' => 'background',
		),

		'end_horizontal_nav_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
