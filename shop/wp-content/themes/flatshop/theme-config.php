...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Footer Address Info', 'themify'),
			'function' => 'store_info_module'
		),
		array(
		...
		array(
			'title' => __('Parallax Scrolling', 'themify'),
			'function' => 'parallax_scrolling_module'
		),
		array(
			'title' => __('Fly-in Animation', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['horizontal_navigation'] = array(
	'title' => __('Horizontal Menus', 'themify'),
	'id' => 'horizontal_navigation',
	'element' => array(
		array(
			'title' => __('Horizontal Navigation Position', 'themify'),
			'id' => 'horizontal_navigation_position',
		...
		array(
			'title' => __('Horizontal Navigation Link', 'themify'),
			'id' => 'horizontal_navigation_link',
		...
		array(
			'title' => __('Horizontal Navigation Hover', 'themify'),
			'id' => 'horizontal_navigation_hover',
			'selector' => '.horizontal-menu a:hover, .horizontal-menu li:hover > a',
			'module' => array(
				'color',
				'text-decoration',
				'background-color'
		...
		array(
			'title' => __('Horizontal Navigation Active (current)', 'themify'),
			'id' => 'horizontal_navigation_active',
		...
		array(
			'title' => __('Horizontal Navigation Active :hover', 'themify'),
			'id' => 'horizontal_navigation_active_hover',
		...
		array(
			'title' => __('Dropdown', 'themify'),
			'id' => 'horizontal_navigation_dropdown',
		...
		array(
			'title' => __('Dropdown Link', 'themify'),
			'id' => 'horizontal_navigation_dropdown_link',
			'selector' => '.horizontal-menu ul a, .horizontal-menu .current_page_item ul a, .horizontal-menu ul .current_page_item a, .horizontal-menu .current-menu-item ul a, .horizontal-menu ul .current-menu-item a, .horizontal-menu li:hover > ul a',
			'module' => array(
				'font-family',
				'font-size',
				'color',
		...
		array(
			'title' => __('Dropdown Hover', 'themify'),
			'id' => 'horizontal_navigation_dropdown_hover',
			'selector' => '.horizontal-menu ul a:hover, .horizontal-menu .current_page_item ul a:hover, .horizontal-menu ul .current_page_item a:hover, .horizontal-menu .current-menu-item ul a:hover, .horizontal-menu ul .current-menu-item a:hover, .horizontal-menu li:hover > ul a:hover',
			'module' => array(
				'color',
				'background-color'
			)
