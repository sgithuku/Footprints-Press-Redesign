	...
	<div id="headerwrap" class="clearfix">
		...
		<header id="header" class="pagewidth">
			...
			<?php if ( themify_is_woocommerce_active() ) : global $woocommerce; ?>
				<a id="cart-icon" href="#slide-cart"><i class="fa fa-shopping-cart icon-shopping-cart"></i><span class="amount_wrapper"><?php echo $woocommerce->cart->get_cart_total(); ?></span></a>
			<?php endif; ?>
