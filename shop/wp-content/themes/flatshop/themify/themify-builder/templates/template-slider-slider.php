		...
		<li style="<?php echo !empty($left_margin) ? 'margin-left:'.$left_margin.';' : ''; ?> <?php echo !empty($right_margin) ? 'margin-right:'.$right_margin.';' : ''; ?>">
				...
				if ( $post_image || themify_check('video_url') == 1 ){ ?>
					...
					<figure class="slide-image">
						<?php if ( $unlink_feat ): ?>
							<?php echo $post_image; ?>
						<?php else: ?>
							<a href="<?php echo $ext_link; ?>" title="<?php echo the_title_attribute('echo=0'); ?>"<?php echo $attr_link_target; ?>>
								<?php echo $post_image; ?>
							</a>
						<?php endif; ?>
					</figure>
			...
			<div class="slide-content">
				<?php if ( $hide_post_title_slider == '' || $hide_post_title_slider == 'no' ): ?>
					...
					<?php else: ?>
						<h3 class="slide-title"><a href="<?php echo $ext_link; ?>" title="<?php the_title_attribute(); ?>"<?php echo $attr_link_target; ?>><?php the_title(); ?></a></h3>
