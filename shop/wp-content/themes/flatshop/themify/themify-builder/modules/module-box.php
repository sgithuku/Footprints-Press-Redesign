...
Themify_Builder_Model::register_module( 'TB_Box_Module', 
	apply_filters( 'themify_builder_module_box', array(
		'options' => array(
			array(
				'id' => 'mod_title_box',
				'type' => 'text',
		...
		'styling_selector' => array(
			'.module-box' => array(
				'font_family', 'font_size', 'line_height', 'text_align', 'color', 'padding', 'margin', 'border_top', 'border_right', 'border_bottom', 'border_left'
			),
