...
if ( file_exists( THEME_DIR . '/customizer-config.php' ) ) {
 ...
 * @param string $script
 */
function themify_wpeditor_button_send_vars( $script = 'editor' ) {
	wp_localize_script( $script, 'themifyEditor', array(
